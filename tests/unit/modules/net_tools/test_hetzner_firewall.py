...
from ansible_collections.ansible.hetzner.plugins.module_utils.hetzner import BASE_URL
from ansible_collections.ansible.hetzner.plugins.modules import hetzner_firewall
...
from ansible_collections.ansible.hetzner.tests.unit.modules.utils import set_module_args
...
def run_module(mocker, module, arguments, fetch_url):
    ...
    mocker.patch('ansible_collections.ansible.hetzner.plugins.module_utils.hetzner.fetch_url', fetch_url)
    mocker.patch('ansible_collections.ansible.hetzner.plugins.module_utils.hetzner.time.sleep', lambda duration: None)
    mocker.patch('ansible_collections.ansible.hetzner.plugins.modules.hetzner_firewall.AnsibleModule.exit_json', exit_json)
    mocker.patch('ansible_collections.ansible.hetzner.plugins.modules.hetzner_firewall.AnsibleModule.fail_json', fail_json)
